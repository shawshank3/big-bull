/**
 * GrowingMarketIcon — an inline SVG depicting a rising candlestick / trending-up chart.
 * Used as the brand logo throughout the app.
 */
export const GrowingMarketIcon = ({ className = '', size = 36 }) => (
  ...
  >
    ...
    {/* Candlestick 1 — bearish (red), left */}
    ...
    {/* Candlestick 2 — bullish (green), center-left */}
    ...
    {/* Candlestick 3 — bullish (green), center-right */}
